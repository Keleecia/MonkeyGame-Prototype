...
function preload() {
 backgroImage=loadImage("IMG_0658.PNG");
  
 monkeyImage=loadAnimation("Square2.PNG");
...
function setup() {
  ...
  ground=createSprite(400,368,3000,10);
  //ground.velocityX=-4;
...
function spawnBanana(){
  if(World.frameCount%80===0){
   ...
   banana.addImage("banana",theSquare);
   banana.scale=0.4; 
   banana.velocityX=-6;
 ...
 if(World.frameCount%250===0){
  ...
  obstacle.addImage("stone",theSquare);
  obstacle.scale=0.6;
